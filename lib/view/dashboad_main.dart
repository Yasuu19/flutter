...
import 'package:ipssi_bd23_2/controller/all_favorites.dart';
...
class _DashBoardState extends State<DashBoard> {
            ...
            actions: [
              ...
              TextButton(
                  onPressed: () {
                    FirestoreHelper()
                        .stockageImage(
                            "images", nameImage!, moi.uid, bytesImage!)
                        .then((value) {
                      setState(() {
                        urlImage = value;
                        moi.avatar = value;
                  ...
                  InkWell(
                    ...
                    child: CircleAvatar(
                      ...
                      child: CircleAvatar(
                        radius: 40,
                        backgroundImage:
                            NetworkImage(moi.avatar ?? defaultImage),
                      ),
                    ),
                  ),
                  Column(
  ...
  Widget bodyPage() {
    switch (indexMenu) {
      case 0:
        return const AllPerson();
      case 1:
        // return Text("Test");
        return const AllFavorites();
